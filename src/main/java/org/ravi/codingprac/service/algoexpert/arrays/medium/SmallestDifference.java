package org.ravi.codingprac.service.algoexpert.arrays.medium;
    ...
    *
    * Hint2:
    * Would it help if the two arrays were sorted? If the arrays were sorted and you were looking at a given pair of numbers, could you
    * efficiently find the next pair of numbers to look at? What are the runtime implications of sorting the arrays?
    *
    * Hint3:
    ...
    * the smaller of the two numbers to find a potentially better pair. Continue until you get a pair with a difference of zero or
    * until one of the pointers gets out of range of its array.
    *
